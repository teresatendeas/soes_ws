...
class I2CBridge(Node):
    ...
    # -------------------------------------------------------------------------
    #  Pump command (write-only, same as before)
    # -------------------------------------------------------------------------
    ...
    # -------------------------------------------------------------------------
    #  Joint command (write-only, same as before)
    # -------------------------------------------------------------------------
    ...
    # -------------------------------------------------------------------------
    #  New: poll ESP32 status byte over I2C (read)
    # -------------------------------------------------------------------------
    def poll_status(self):
        ...
        if self.last_switch_state is None or switch_on != self.last_switch_state:
            if switch_on:
                ...
                # TODO: hook safe-stop / restart logic here if desired.
                # For example:
                #   - publish another topic
                #   - call a service to stop joints & pump
